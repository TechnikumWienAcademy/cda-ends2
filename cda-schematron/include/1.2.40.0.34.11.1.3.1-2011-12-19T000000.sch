...
Description: 
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="template-1.2.40.0.34.11.1.3.1-2011-12-19T000000">
...
-->
    <rule context="*[hl7:observationMedia[hl7:templateId[@root = '1.2.40.0.34.11.1.3.1']]]" id="d3462930e214-false-d3467977e0">
...
Item: (EingebettetesObjektEntry)
-->
    <rule context="*[hl7:observationMedia[hl7:templateId[@root = '1.2.40.0.34.11.1.3.1']]]/hl7:observationMedia[hl7:templateId[@root = '1.2.40.0.34.11.1.3.1']]" id="d3462930e217-false-d3467993e0">
        ...
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--exnds-?id=1.2.40.0.34.11.1.3.1" test="count(hl7:templateId[@root = '1.2.40.0.34.11.1.3.1']) &gt;= 1">(EingebettetesObjektEntry): Element hl7:templateId[@root = '1.2.40.0.34.11.1.3.1'] ist required [min 1x].</assert>
...
Item: (EingebettetesObjektEntry)
-->
    <rule context="*[hl7:observationMedia[hl7:templateId[@root = '1.2.40.0.34.11.1.3.1']]]/hl7:observationMedia[hl7:templateId[@root = '1.2.40.0.34.11.1.3.1']]/hl7:templateId[@root = '1.2.40.0.34.11.1.3.1']" id="d3462930e222-false-d3468026e0">
        <extends rule="II"/>
...
Item: (EingebettetesObjektEntry)
-->
    <rule context="*[hl7:observationMedia[hl7:templateId[@root = '1.2.40.0.34.11.1.3.1']]]/hl7:observationMedia[hl7:templateId[@root = '1.2.40.0.34.11.1.3.1']]/hl7:value[not(@nullFlavor)]" id="d3462930e226-false-d3468039e0">
        <extends rule="ED"/>
